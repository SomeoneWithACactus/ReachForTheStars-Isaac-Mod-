local root = "scripts.libraries.unlockapi" -- Replace this with the path of the "unlockapi" folder in your mod
local modname = "Reach-for-the-Stars" --Replace with your mod name
local version = 0.35
